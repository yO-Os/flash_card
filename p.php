...
<?php endif; ?>
 ...
 <div id="deckForm">
    ...
    <div>
      ...
      <div style="margin-top:8px"><button id="addSample">Add Sample Cards</button><button id="clearDeck">Clear Cards</button></div>
    </div>
  </aside>
  ...
  <main class="main">
    ...
    <div class="panel" id="sidePanel" style="margin-top:12px">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px"><strong>Edit Cards</strong><div class="small muted">Add, import, export cards</div></div>
      ...
      <div style="display:flex;gap:8px;margin-top:8px"><button id="addCardBtn">Add Card</button><button id="bulkImport">Paste JSON</button><button id="clearCards">Clear All</button></div>
      <hr />
...
<footer class="muted tiny">Built with plain HTML/CSS/JS — stores decks in your browser using localStorage.</footer>
</body>
</html>
