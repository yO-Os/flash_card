...
<?php endif; ?>
 ...
 <div id="deckForm">
      ...
      <div id="EditCardForm">
        ...
        <div>
            <button id="submitCard" name="submit">Submit</button>
  ...
  <main class="main">
    <div class="panel card-view">
      ...
      <div class="statbar">
        ...
        <div id="statText" class="muted tiny">0 reviewed • 0 left</div>
    ...
    <div class="panel" id="sidePanel" style="margin-top:12px">
      ...
      <span id="AddCardError" style="color:red; font-size:0.9rem; display:none;"></span>
      <div style="display:flex;gap:8px;margin-top:8px"><button id="addCardBtn">Add Card</button><button id="clearCards">Cancel</button></div>
      <hr />
